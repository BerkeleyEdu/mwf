...
Config::set('choice', 'title_text', Config::get('global', 'title_text') . ' Choice');

Config::set('choice', 'header_image_sub', '../assets/img/berkeley-logo.png');

Config::set('choice', 'header_image_sub_alt', 'UC Berkeley');
