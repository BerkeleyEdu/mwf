...
Config::set('directory', 'title_text', Config::get('global', 'title_text') . ' Directory');

Config::set('directory', 'header_image_sub', '../assets/img/berkeley-logo.png');

Config::set('directory', 'header_image_sub_alt', 'UC Berkeley');
