...
<head>
    <title><?php echo Config::get('sports', 'title_text'); ?></title>
...
<body>
    	...
    	<h1 id="header">
        <a href="../">
        <img src="<?php echo Config::get('sports', 'header_image_sub'); ?>" alt="<?php echo Config::get('sports', 'header_image_sub_alt'); ?>" width="119" height="35" />       
        </a>
		<a href="index.php">
		<img src="../assets/img/l2-athletics.png" alt="" width="45" height="35"/>
