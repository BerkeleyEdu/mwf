...
?><title>UCB Mobile | Social Media | Twitter</title>
		<div class="menu-full menu-detailed menu-padded">
            <h1 class="light menu-first, menu-last">Twitter</h1>
             <ol>
				<li class="menu-first">
                	<a href="http://mobile.twitter.com/UCBerkeley">UC Berkeley</a></li>
				 <li>
                 	<a href="http://mobile.twitter.com/UCBerkeleyNews">UC Berkeley News</a></li>
                 <li class="menu-last">
