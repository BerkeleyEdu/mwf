...
{						
	...
	$calday_title = $image . "Saturday, April 12<br/>300 unique events!";	
...
a.src=document.location.protocol+"//dnn506yrbagrg.cloudfront.net/pages/scripts/0011/9899.js?"+Math.floor(new Date().getTime()/3600000);
