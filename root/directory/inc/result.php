...
?>
    ...
    <?php if(isset($user['title'][0]) || isset($user['berkeleyeduunitcalnetdeptname'][0]) || isset($user['berkeleyeduunithrdeptname'][0])){ ?>
    <div>
    ...
    <?php if(isset($user['berkeleyeduunitcalnetdeptname'][0]) || isset($user['berkeleyeduunithrdeptname'][0])){ ?>
