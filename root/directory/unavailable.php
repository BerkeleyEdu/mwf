...
<head>
     <title><?php echo Config::get('directory', 'title_text'); ?></title>
...
<body>
    ...
    <?php include('inc/header.php'); ?>
      ...
      <a class="button-full button-padded" href="/directory">The campus directory service is currently unavailable.  Please try again later.</a>
