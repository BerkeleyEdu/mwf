...
?>
    ...
    <div class="menu-full menu-detailed menu-padded">
         <h1 class="light menu-first">Sports Facilities</h1>
         <ol>
              <li class=only-webkit><a href="map_sports_fac.php">All Sports Facilities</a></li>
			 <?php
             foreach($locations as $location)
             {
                echo '<li><a href="map_sports_fac.php?loc='.urlencode($location['name']).'">'.$location['name'].'</a></li>';
             }
             ?>
        </ol>
    </div>
