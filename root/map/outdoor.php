...
?>
    ...
    <div class="menu-full menu-detailed menu-padded">
         <h1 class="light menu-first">Outdoor</h1>
         <ol>
              <li class=only-webkit><a href="map_outdoor.php">All Outdoor</a></li>
			 <?php
             foreach($locations as $location)
             {
                echo '<li><a href="map_outdoor.php?loc='.urlencode($location['name']).'">'.$location['name'].'</a></li>';
             }
             ?>
        </ol>
    </div>
