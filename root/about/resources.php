...
<div class="content-full content-padded">
        ...
        <div class="content-last">       
          ...
          <ol>
            <li><a href="http://berkeley.edu/mobile/menu_sample_qa.html">Menu Sample QA</a></li>
			 <li><a href="http://www.berkeley.edu/mobile/menu_sample_ssl_qa.html">Menu Sample QA with SSL</a></li>
            <li><a href="http://berkeley.edu/mobile/menu_sample_prod.html">Menu Sample Production</a></li>
            <li><a href="http://berkeley.edu/mobile/content_sample_qa.html">Content Sample QA</a></li>
            <li><a href="http://berkeley.edu/mobile/content_sample_prod.html">Content Sample Production</a></li>
          </ol>
           </div>
          </div>
          </div>
...
<div class="content-full content-padded">
		...
		<div class="content-last">
        <p>Subscribe to <a href="mailto: mobilenet-request@lists.berkeley.edu?subject=subscribe">mobilenet@lists.berkeley.edu</a> </p>
        <p>Send questions about mobile development at Berkeley to <a href="mailto:mobilesupport@berkeley.edu">mobilesupport@berkeley.edu</a></p>
</div>
		 </div>
